...
<form action="" method="post" id="form">
		<input id="menudate" name="menudate" type="hidden" />
      ...
      <div class="modal-body" style="height:150px">
      		  ...
      		  <div class="form-group">
						...
						<table>
								<tr>
										<td>	
							类型(<span style="color:red">*</span>)：	<input type="radio" name="ipt"  id="ipt_radio_url" value="url" > 链接，
