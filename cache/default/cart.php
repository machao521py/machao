...
<head>
 ...
 <meta name="viewport" content="initial-scale=1.0,maximum-scale=1.0,user-scalable=no">
	...
	<script type="text/javascript" src="http://localhost/machao/themes/default/__RESOURCE__/script/jquery-1.7.2.min.js"></script>
	<script type="text/javascript" src="http://localhost/machao/themes/default/__RESOURCE__/script/common.js"></script>
	<link href="http://localhost/machao/themes/default/__RESOURCE__/recouse/css/bottom.css" rel="stylesheet" type="text/css" />
	<link type="text/css" rel="stylesheet" href="http://localhost/machao/themes/default/__RESOURCE__/mobile/style/bootstrap.css">
	<script type="text/javascript" src="http://localhost/machao/themes/default/__RESOURCE__/mobile/script/bootstrap.min.js"></script>
	<script type="text/javascript" src="http://localhost/machao/themes/default/__RESOURCE__/script/angular.min.js"></script>
	<link type="text/css" rel="stylesheet" href="http://localhost/machao/themes/default/__RESOURCE__/recouse/css/font-awesome.min.css" />
	<link type="text/css" rel="stylesheet" href="http://localhost/machao/themes/default/__RESOURCE__/mobile/style/common.mobile.css">
	<script type="text/javascript" src="http://localhost/machao/themes/default/__RESOURCE__/script/cascade.js"></script>
	<script type="text/javascript" src="http://localhost/machao/themes/default/__RESOURCE__/mobile/script/jquery.touchwipe.js"></script>
	<script type="text/javascript" src="http://localhost/machao/themes/default/__RESOURCE__/mobile/script/swipe.js"></script>
</head>

<body style="padding-top:0px; ">
<div class="main">
<script type="text/javascript" src="http://localhost/machao/themes/default/__RESOURCE__/mobile/images/jquery.gcjs.js"></script>
<link type="text/css" rel="stylesheet" href="http://localhost/machao/themes/default/__RESOURCE__/mobile/style/style.css">
...
<div style='text-align:center;padding:50px 0 50px 0; <?php if(count($list)>0) { ?>display:none<?php } ?>' id='cartempty'>
    <img src="http://localhost/machao/themes/default/__RESOURCE__/mobile/images/icon_cart_empty.png" /><br/><br/>
